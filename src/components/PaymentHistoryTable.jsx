...
const PaymentHistoryTable = ({ paymentHistory }) => (
  <div className="table-view">
    <BootstrapTable className="" data={paymentHistory} striped hover>
      ...
      <TableHeaderColumn dataField="amountDisplay" dataFormat={amountFormatter} className="amount" columnClassName="amount" width="150" dataSort dataAlign="right">Amount</TableHeaderColumn>
    </BootstrapTable>
  </div>
);
