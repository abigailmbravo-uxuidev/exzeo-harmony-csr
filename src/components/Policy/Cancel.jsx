      ...
      <PolicyConnect>
        ...
        <div className="basic-footer btn-footer">
          ...
          <div className="btn-wrapper">
            <button aria-label="reset-btn form-cancel" type="button" className="btn btn-secondary" onClick={() => this.props.reset('CancelPolicy')}>Clear</button>
            <button aria-label="reset-btn form-cancel"  type="submit" className="btn btn-cancel">Cancel Policy</button>
          </div>
        </div>
      </PolicyConnect>
    );
