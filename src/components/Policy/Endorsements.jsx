            ...
            <div className="endorsements">
                      ...
                      <div className="flex-child col3">
                        ...
                        <div className="form-group-double-element">
                          <CurrencyField
                            ...
                            styleName=""
                            name="dwellingAmount"
                            min={initialValues.dwellingMin}
                            max={initialValues.dwellingMax}
                            disabled
                          />
                          <CurrencyField
                        ...
                        <div className="form-group-double-element">
                          ...
                          <SelectField
                            ...
                            onChange={event => updateDependencies(event, 'otherStructuresAmountNew', 'dwellingAmountNew', this.props)}
                        ...
                        <div className="form-group-double-element">
                          ...
                          <SelectField
                            ...
                            onChange={event => updatepersonalPropertyDependnecies(event, 'personalPropertyAmountNew', 'dwellingAmountNew', this.props)}
                            validations={['required']}
                          />
                        </div>
                        <div className="form-group-double-element">
                        ...
                        <div className="form-group-double-element">
                          ...
                          <SelectField
                            ...
                            component="select"
                            styleName=""
                            onChange={event => updateDependencies(event, 'calculatedHurricane', 'dwellingAmountNew', this.props)}
                            validations={['required']}
                          />
                        </div>
                        <div className="form-group-double-element">
                          ...
                          <SelectField
                            ...
                            component="select"
                            styleName=""
                            onChange={() => updateCalculatedSinkhole(this.props)}
                            answers={[
                              {
                                answer: false,
              ...
              <div className="endo-results-calc">
                <div className="flex-parent">
                  ...
                  <button type="submit" tabIndex="0" className="btn btn-primary" disabled={(!appState.data.isCalculated && pristine) || appState.data.isSubmitting || (appState.data.isCalculated)}>{appState.data.isCalculated ? 'Save' : 'Review'}</button>
