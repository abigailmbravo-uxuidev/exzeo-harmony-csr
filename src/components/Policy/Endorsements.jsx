                ...
                <section>
                  ...
                  <div className="flex-parent">
                    ...
                    <div className="flex-child col3">
                      ...
                      <div className="form-group-double-element">
                        <CurrencyField validations={['required']} label={'Incidental Occ Liability'} styleName={''} name={'incidentalOccLiability'} disabled />
                        <CurrencyField name={'incidentalOccLiabilityNew'} label={''} styleName={''} disabled />
                      </div>
