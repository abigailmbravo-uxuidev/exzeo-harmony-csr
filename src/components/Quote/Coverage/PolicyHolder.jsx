    ...
    <div id="policy-holder-a" className="flex-child policy-holder-a">
      ...
      <div className="flex-parent col2 policy-holder-a-name">
        <div className="flex-child policy-holder-a-first-name">
          <Field
            component={Input}
            validate={[validation.isValidNameFormat, validation.isRequired]}
            label="First Name"
            name="pH1FirstName"
      ...
      <div className="flex-parent col2 policy-holder-b-name">
        <div className="flex-child policy-holder-b-first-name">
          <Field
            ...
            label="First Name"
            component={Input}
            validate={[firstNameDepends, secondaryPhoneOptionalDepends, validation.isValidNameFormat]}
        ...
        <div className="flex-child policy-holder-b-last-name">
          <Field
            ...
            label="Last Name"
            component={Input}
            validate={[lastNameDepends, secondaryPhoneOptionalDepends, validation.isValidNameFormat]}
            onChange={setPHToggle}
