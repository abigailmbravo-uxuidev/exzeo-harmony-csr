...
const AgencySearchCard = ({
  agency, index, agencyKeyEnter, agencySelection
}) => (
  <div className="card-wrapper" key={index} onKeyPress={agencyKeyEnter} tabIndex="0">
    <span className="fa fa-chevron-circle-right" id={`agency-code-${agency.agencyCode}`} onClick={agencySelection} />
    <div className="agency contact card">
      ...
      <div className="contact-details">
        <div className="card-name">
          <h4 onClick={agencySelection} className="agency"><span className="agency-code">{agency.agencyCode}</span> | <span className="agency-display-name">{agency.displayName}</span> | <span className="agency-legal-name">{agency.legalName}</span> | <span className="agency-license">{agency.licenseNumber}</span></h4>
