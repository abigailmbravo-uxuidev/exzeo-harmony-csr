...
describe('Test endorsementModel', () => {
  const policyMock = {
    ...
    policyHolders: [{}, {}],
    property: {
      windMitigation: {}, physicalAddress: {}, distanceToFireHydrant: 0, yearOfRoof: 1987
    },
  ...
  describe('calculateEndorsementDate', () => {
    it('Should calculateEndorsementDate for America/New_York', () => {
      expect(endorsementModel.calculateEndorsementDate('2017-05-05', 'America/New_York')).toBe('2017-05-05T04:00:00Z');
    });

    describe('calculateEndorsementDate', () => {
      it('Should setEndorsementDate same as effectiveDate', () => {
        expect(endorsementModel.setEndorsementDate('2017-05-05', '2017-05-05')).toBe('2017-05-05');
      });

      it('Should setEndorsementDate equal to effectiveDate when less than effectiveDate', () => {
        expect(endorsementModel.setEndorsementDate('2017-05-04', '2017-05-05')).toBe('2017-05-05');
      });

      it('Should setEndorsementDate equal to endDate', () => {
        expect(endorsementModel.setEndorsementDate('2017-05-06', '2017-05-10')).toBe('2017-05-10');
      });
    });
