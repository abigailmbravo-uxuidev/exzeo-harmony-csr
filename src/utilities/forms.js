...
export const getUnderwritingAnswers = (name, questions) => _get(_find(questions, { name }), 'answers') || [];
export const getUnderwritingQuestionName = (name, questions) => _get(_find(questions, { name }), 'question', '');
