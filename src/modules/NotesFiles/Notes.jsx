...
const attachmentUrl = ({ attachments, setAppError}) => (
  <span>
...
const Notes = (props) => {
  ...
  return (
    <BootstrapTable
      ...
      <TableHeaderColumn className="attachments" columnClassName="attachments" dataField="attachments" dataSort dataFormat={(attachments) => attachmentUrl({ attachments, setAppError })} filterValue={attachmentFilter} sortFunc={sortFiles}>File</TableHeaderColumn>
    </BootstrapTable>
  );
};
