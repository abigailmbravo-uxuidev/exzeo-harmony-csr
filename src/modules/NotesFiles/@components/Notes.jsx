  ...
  return (
    <BootstrapTable
      ...
      multiColumnSearch>
        ...
        <TableHeaderColumn className="count" columnClassName="count" dataField="noteAttachments" dataFormat={notesUtils.attachmentCount} hidden />
        <TableHeaderColumn className="file-type" columnClassName="file-type" dataField="noteAttachments" dataSort dataFormat={notesUtils.attachmentType} >File Type</TableHeaderColumn>
        <TableHeaderColumn className="attachments" columnClassName="attachments" dataField="noteAttachments" dataSort dataFormat={attachmentUrl} filterValue={notesUtils.attachmentFilter} sortFunc={notesUtils.sortFiles}>File</TableHeaderColumn>
    </BootstrapTable>
  );
};
