...
export const getFileName = a => a.fileName ? a.fileName : a.fileUrl.substring(a.fileUrl.lastIndexOf("/") + 1);

export const showCreatedBy = createdBy => (createdBy ? createdBy.userName : '');

export const attachmentCount = attachments => (attachments ? attachments.length : 0);

export const attachmentType = attachments => (attachments.length > 0 ? toTitleCase(attachments[0].fileType) : '');
