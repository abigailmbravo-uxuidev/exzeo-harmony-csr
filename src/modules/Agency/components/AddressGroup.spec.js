...
describe('Testing AddressGroup component', () => {
  it('should render', () => {
    ...
    expect(wi.filterTerritoryManager('FL', 'VOLUSIA')).toEqual(props.territoryManagers[0]);
    expect(wi.filterTerritoryManager('N/A', 'N/A')).toBeFalsy();

    wi.normalizeSameAsMailing('mailingAddress')('', '', { sameAsMailing: true, physicalAddress: { state: 'FL' } });
    wi.normalizeSameAsMailing('physicalAddress')('', '', { sameAsMailing: true, physicalAddress: { state: 'FL' } });
