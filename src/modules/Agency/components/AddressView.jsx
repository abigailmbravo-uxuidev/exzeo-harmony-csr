    ...
    <React.Fragment>
      <div className="physical-address" data-test="physical-address">
        ...
        <div className="address flex-col">
          ...
          {agencyBranchData.physicalAddress.address2 ? `, ${agencyBranchData.physicalAddress.address2}` : ''}
          <div>{agencyBranchData.physicalAddress.city}, {agencyBranchData.physicalAddress.state} {agencyBranchData.physicalAddress.zip}</div>
        </div>
      </div>
      <div className="mailing-address" data-test="mailing-address">
        ...
        <div className="address form-group">
          ...
          {agencyBranchData.mailingAddress.address2 ? `, ${agencyBranchData.mailingAddress.address2}` : ''}
          <div>{agencyBranchData.mailingAddress.city}, {agencyBranchData.mailingAddress.state} {agencyBranchData.mailingAddress.zip}</div>
        </div>
        <div className="county form-group" data-test="county">
          <label>County</label>
          {agencyBranchData.physicalAddress.county}
        </div>
        <div className="territoryManagerId flex-col" data-test="territory-manager">
