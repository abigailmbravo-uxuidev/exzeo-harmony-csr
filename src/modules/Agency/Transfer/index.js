...
const policyTestData = [{
    ...
    policyVersion: '1',
    PolicyID: '1866c036a46eb72908f3f547',
    companyCode: 'TTIC',
    state: 'FL',
    product: 'HO3',
    policyNumber: '12-1234568-12',
    billToId: '1866c036a46eb72908f3f547',
    billPlan: 'Annual',
    eligibility: 'Yes',
    effectiveDate: '2017-01-04T20:14:46.793Z',
    endDate: '2018-01-04T20:14:46.793Z',
...
const mapStateToProps = state => ({
  ...
  policies: policyTestData,
  policyNumberList: policyTestData.map(p => { return { answer: p.policyNumber, label: p.policyNumber }})
});
