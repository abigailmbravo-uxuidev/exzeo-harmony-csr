        ...
        >
          <div className="card-block user-script">
            <p className="script margin bottom">
              I need to confirm a few more items prior to sending the
              application
            </p>
            <ul>
              <li className="script">
            ...
            <p className="script margin bottom">
              PLEASE NOTE: All signatures must be completed within 10 days, or
            ...
            <p className="scriptInfo margin bottom">
              ...
              {PRODUCT_DESCRIPTION[initialValues.product]} Application. Once you
              click &ldquo;SEND&rdquo; no changes can be made to this quote.
            </p>
          </div>
