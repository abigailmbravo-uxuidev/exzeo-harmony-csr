...
describe('Quote workflow Summary page tests', () => {
  const baseProps = {
    ...defaultQuoteWorkflowProps,
    quote: {
    ...
    match: { params: { step: 'summary', quoteNumber: '12-345-67' } }
  };
  describe('Summary testing with finished Quote', () => {
    ...
    it('POS:Primary Policyholder Testing', () => {
      const _ = render(<QuoteWorkflow {...props} />);
    ...
    it('POS:Mailing Address', () => {
      const { getByText, getByTestId } = render(<QuoteWorkflow {...props} />);
      const _ = document.querySelector('form#QuoteWorkflowCSR');
