      ...
      <h4>&nbsp;</h4>
            ...
            <div hidden>
              <TextField
                ...
                label={'textField1'}
                styleName={'textField1'}
                name={'textField1'}
              />
              <DisplayField
                validations={['required']}
                label={'textField2'}
                styleName={'textField2'}
                name={'textField2'}
              />
              <SelectField
                name="billTo"
                ...
                onChange={function () { }}
                validations={['required']}
                answers={[{ answer: 'Policy Holder', label: 'Policy Holder' }, { answer: 'Mortgagee', label: 'Mortgagee' }]}
              ...
              <RadioField
                ...
                onChange={function () { }}
                segmented
                answers={[{ answer: 'Annual', label: 'Annual' }, { answer: 'Semi-Annual', label: 'Semi-Annual' }]}
              />

              <SliderField
                validations={['required']}
                name={'deductible'}
                styleName={'deductible'}
                label={'Deductible'}
                onChange={function () { }}
                leftLabel={'100,000'}
                max={500000}
