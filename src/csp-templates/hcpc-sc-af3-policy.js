  ...
  pages: [
    {
      ...
      components: [
        {
          id: '18010242-72de-414c-9d06-f00387a35b79',
          component: '$SECTION',
          dependencies: '',
          data: {
          ...
          children: [
            {
              id: '9413dda9-73a9-4d91-9649-895ffac5d349',
              component: '$SECTION',
              dependencies: '',
              data: {
              ...
              children: [
                {
                  id: 'b2fa58cc-3b4f-4a5a-a33f-467238146e5f',
                  component: '$TITLE',
                  dependencies: '',
                  data: {
                ...
                {
                  id: 'c5ab7ff2-3548-4481-82f1-389fff30b609',
                  component: '$SECTION',
                  dependencies: '',
                  data: {
                    className: 'row'
                  ...
                  children: [
                    {
                      id: '490b568b-5cd3-41e1-878d-146ce104976a',
                      component: '$SECTION',
                      dependencies: '',
                      data: {
                      ...
                      children: [
                        {
                          id: '0aadb182-485b-47eb-9c45-0daf9b19cb06',
                    ...
                    {
                      id: '96a5374b-0f42-431d-982e-88d0fa817670',
                      component: '$SECTION',
                      dependencies: '',
                      data: {
                        className: 'coverage table',
                      ...
                      children: [
                        {
                          id: 'e5c80126-4f59-49c0-a8ce-ce58ee3975e1',
                          component: '$ENTITY_DETAILS',
                          dependencies: '',
                          data: {
                            extendedProperties: {
                    ...
                    {
                      id: 'a0e96cce-eb06-4f42-a9aa-fb17d66ce22d',
                      component: '$SECTION',
                      dependencies: '',
                      data: {
                        className: 'coverage table',
                      ...
                      children: [
                        {
                          id: '4eda0b37-80ee-47c6-a77f-1106e3dee595',
                          component: '$ENTITY_DETAILS',
                          dependencies: '',
                          data: {
                            extendedProperties: {
                ...
                {
                  id: 'e0e1d4ee-753f-40ef-87d2-444dde3b1586',
                  component: '$SECTION',
                  dependencies: '',
                  data: {
                    className: 'row'
                  ...
                  children: [
                    {
                      id: 'fa82af7b-0537-4aec-92b8-346b51d1bf45',
                      component: '$SECTION',
                      dependencies: '',
                      data: {
